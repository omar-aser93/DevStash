// npm run db:seed -> runs the seed, but we added it first in package.json, after we install -> npm install pg @prisma/adapter-pg bcryptjs, npm install -D @types/pg @types/bcryptjs tsx, npx prisma generate
