...
7. Check if there is a .env.production file, if so, make sure it has the same variables (not always the same value) as the .env. If something is missing, tell me.
